...
var parseGIF = function(st,callback) {
  ...
  var doImg = function(img) {
    ...
    frames.push({img:tmpCanvas.toDataURL(),width:hdr.width,height:hdr.height});
  ...
  var parseBlock = function() {
    ...
    if (block.type !== 'eof') {
      // Report progress
      $('body').trigger('gif-progress',Math.round(st.pos*100/st.data.length));
